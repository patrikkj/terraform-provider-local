		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.local_file.test", "path", tempFile.Name()),
					resource.TestCheckResourceAttr("data.local_file.test", "content", content),

					// Test reading a non-existent file with fail_if_absent = false
					resource.TestCheckResourceAttr("data.local_file.missing_optional", "path", "/nonexistent/file"),
					resource.TestCheckResourceAttr("data.local_file.missing_optional", "content", ""),
				),
			},
		},
	})
...
data "local_file" "missing_optional" {
...
func testAccLocalFileDataSourceConfigFailIfAbsent() string {
	return `
data "local_file" "missing_required" {
